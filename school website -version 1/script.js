...
document.addEventListener('DOMContentLoaded', () => {
    const text = `At Bramha Kunja Shikshya Sadan, we are dedicated to nurturing young minds from Play Group to Class 10. Our
    institution strives to provide a holistic education, fostering academic excellence, creativity, and moral
    integrity. Join us on a journey of learning and growth in a supportive and inspiring environment.`;
